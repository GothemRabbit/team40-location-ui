...
import bham.team.service.mapper.LocationMapper;
...
class LocationResourceIT {
    ...
    public static Location createEntity() {
        return new Location().address(DEFAULT_ADDRESS).latitude(DEFAULT_LATITUDE).longitude(DEFAULT_LONGITUDE).postcode(DEFAULT_POSTCODE);
    }
    ...
    public static Location createUpdatedEntity() {
        return new Location().address(UPDATED_ADDRESS).latitude(UPDATED_LATITUDE).longitude(UPDATED_LONGITUDE).postcode(UPDATED_POSTCODE);
    }
    ...
    void putExistingLocation() throws Exception {
        ...
        updatedLocation.address(UPDATED_ADDRESS).latitude(UPDATED_LATITUDE).longitude(UPDATED_LONGITUDE).postcode(UPDATED_POSTCODE);
    ...
    void fullUpdateLocationWithPatch() throws Exception {
        ...
        partialUpdatedLocation.address(UPDATED_ADDRESS).latitude(UPDATED_LATITUDE).longitude(UPDATED_LONGITUDE).postcode(UPDATED_POSTCODE);

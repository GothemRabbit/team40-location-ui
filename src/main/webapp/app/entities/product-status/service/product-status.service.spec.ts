...
import { sampleWithFullData, sampleWithNewData, sampleWithPartialData, sampleWithRequiredData } from '../product-status.test-samples';

import { ProductStatusService, RestProductStatus } from './product-status.service';

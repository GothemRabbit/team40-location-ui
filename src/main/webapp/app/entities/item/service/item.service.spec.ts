...
import { sampleWithFullData, sampleWithNewData, sampleWithPartialData, sampleWithRequiredData } from '../item.test-samples';

import { ItemService, RestItem } from './item.service';

const requireRestSample: RestItem = {
  ...sampleWithRequiredData,
  timeListed: sampleWithRequiredData.timeListed?.toJSON(),
};

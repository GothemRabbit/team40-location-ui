...
type RestOf<T extends IConversation | NewConversation> = Omit<T, 'dateCreated'> & {
...
export class ConversationService {
  ...
  protected convertDateFromServer(restConversation: RestConversation): IConversation {
    return {
      ...restConversation,
      dateCreated: restConversation.dateCreated ? dayjs(restConversation.dateCreated) : undefined,
    };
  }
